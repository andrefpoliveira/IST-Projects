        ...
        if file[0]=='a' or file[0]=='t':
            ...
            for idataset in range(0,27):     
                ...
                try:
                    ...
                    print(O+f"Time: {time.time() - start_time} {len(str(T))} // Number Of Rows {len(Y)} Number of Columns {len(D[0])}"+W)
                    Yp = classify(T,D)
            ...
            #for idataset in []:
                ...
                try:
                    ...
                    print(O+f"Time: {time.time() - start_time} // Number Of Rows {len(Y)} Number of Columns {len(D[0])}"+W)
                    print(B+f"{len(str(Tc))}"+W)
